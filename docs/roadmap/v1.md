...
- **The validation harness is in CI and green** ([.github/workflows/pg-delta-next.yml](../../.github/workflows/pg-delta-next.yml)):
  - corpus **210 scenarios × 2 directions** (420 cases) under the full proof
    loop, on **PG 15, 17 AND 18**, `EXPECTED_RED` **empty**;
...
The user-facing surface over the ready engine. Detail in [`the roadmap index`](README.md).
